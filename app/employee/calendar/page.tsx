...
export default function EmployeeCalendarPage() {
  ...
  return (
    <EmployeeLayout title="Leave Calendar">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-[#0f1f3d] mb-1">My Leave Calendar</h2>
        <p className="text-gray-500 text-sm">Visual overview of your leave schedule</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            {!selectedDay ? (
              <p className="text-gray-400 text-sm">Click a day to see your leave details</p>
            ) : (
                ...
                {selectedDayLeaves.map((l, i) => (
                  <div key={i} className="p-3 bg-gray-50 rounded-lg border border-gray-100">
                    <div className="flex items-center justify-between mb-1">
                      <p className="font-semibold text-gray-800 text-sm">{l.leaveType}</p>
                    ...
                    <p className="text-xs text-gray-400">{l.duration} days</p>
                  </div>
                ))}
              </div>
            )}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            {loading ? <p className="text-gray-400 text-sm animate-pulse">Loading...</p> : (() => {
              ...
              return (
                <div className="space-y-2">
                  <div className="flex justify-between text-sm"><span className="text-gray-500">Total leaves</span><span className="font-bold text-[#0f1f3d]">{monthLeaves.length}</span></div>
