      ...
      {!show ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3">
            <button type="button" onClick={() => { setShow(false); setError(''); setForm({ currentPassword: '', newPassword: '', confirmPassword: '' }); }}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <span className="px-2 py-0.5 bg-white/20 rounded text-xs font-medium">Admin</span>
